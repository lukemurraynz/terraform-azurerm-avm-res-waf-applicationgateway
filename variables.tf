...
variable "name" {
  ...
  validation {
    ...
    error_message = "The name must be between 1 and 80 characters long, start and end with a letter or number, and can only contain letters, numbers, and hyphens."
  }
}
